    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/teacher"><span class="nav-icon"><i class="fas fa-home"></i></span><span>Tổng quan</span></a></div>
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/teacher/attendance" class="active"><span class="nav-icon"><i class="fas fa-calendar-check"></i></span><span>Điểm danh</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Điểm danh</h2>
                    <span>Điểm danh hàng ngày cho học sinh</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            ...
                            <p>Cập nhật trạng thái điểm danh cho học sinh</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị danh sách học sinh để điểm danh hàng ngày.</p>
                    <span class="team-badge">Thành viên 3 sẽ triển khai</span>
                </div>
            </main>
        </div>
    </div>
