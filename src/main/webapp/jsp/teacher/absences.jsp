    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/teacher/absences" class="active"><span class="nav-icon"><i class="fas fa-user-slash"></i></span><span>Xin nghỉ ăn</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Xin nghỉ ăn</h2>
                    <span>Gửi yêu cầu xin nghỉ ăn cho học sinh</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Xin nghỉ ăn</h1>
                            <p>Gửi yêu cầu xin nghỉ ăn cho học sinh trong lớp</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ cho phép gửi yêu cầu xin nghỉ ăn cho học sinh.</p>
