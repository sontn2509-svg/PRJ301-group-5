    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/teacher/my-class" class="active"><span class="nav-icon"><i class="fas fa-users"></i></span><span>Lớp học</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Lớp học</h2>
                    <span>Thông tin lớp học được phân công</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            ...
                            <p>Xem thông tin lớp học và học sinh được phân công</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị thông tin lớp học và danh sách học sinh.</p>
