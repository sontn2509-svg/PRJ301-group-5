...
<div class="nav-item"><a href="<%= ctx %>/kitchen/ingredients" class="<%= currentUri.contains("ingredients") ? "active" : "" %>"><span class="nav-icon"><i class="fas fa-carrot"></i></span><span>Nguyên liệu</span></a></div>
