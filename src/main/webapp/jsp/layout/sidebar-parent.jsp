...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item"><a href="<%= ctx %>/parent/absences" class="<%= currentUri.contains("absences") ? "active" : "" %>"><span class="nav-icon"><i class="fas fa-user-slash"></i></span><span>Báo nghỉ</span></a></div>
        <div class="nav-item"><a href="<%= ctx %>/parent/history" class="<%= currentUri.contains("history") ? "active" : "" %>"><span class="nav-icon"><i class="fas fa-history"></i></span><span>Lịch sử & Tiền ăn</span></a></div>        
