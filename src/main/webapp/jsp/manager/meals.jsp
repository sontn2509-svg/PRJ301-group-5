    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/manager/meals" class="active"><span class="nav-icon"><i class="fas fa-utensils"></i></span><span>Lịch sử bếp</span></a></div>
        ...
        <div class="main-content">
            ...
            <main class="page-content">
                ...
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị lịch sử các bữa ăn đã nấu với thông tin chi tiết.</p>
