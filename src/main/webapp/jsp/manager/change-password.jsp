...
<head>
    ...
    <title>Đổi mật khẩu - Quản lý - KindergartenKitchen</title>
                    ...
                    <div class="panel-body">
                        <form method="post" action="${pageContext.request.contextPath}/manager/change-password">
                            ...
                            <div style="display: flex; gap: 12px; margin-top: 8px;">
                                ...
                                <a href="${pageContext.request.contextPath}/manager/dashboard" class="btn btn-ghost"><i class="fas fa-arrow-left"></i> Quay lại</a>
                            </div>
                        </form>
                    </div>
                </div>
