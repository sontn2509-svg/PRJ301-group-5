    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/manager/classes" class="active"><span class="nav-icon"><i class="fas fa-chalkboard"></i></span><span>Lớp học</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Lớp học</h2>
                    <span>Quản lý thông tin các lớp học</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            ...
                            <p>Thêm, sửa, xóa thông tin các lớp học trong trường</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị danh sách lớp học với chức năng CRUD (Thêm, Sửa, Xóa).</p>
