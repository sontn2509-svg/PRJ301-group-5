    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/manager"><span class="nav-icon"><i class="fas fa-home"></i></span><span>Tổng quan</span></a></div>
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/manager/ingredients" class="active"><span class="nav-icon"><i class="fas fa-carrot"></i></span><span>Nguyên liệu</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Nguyên liệu</h2>
                    <span>Quản lý nguyên liệu cho bếp</span>
                </div>
                <div class="header-right">
                    <div class="header-date"><i class="far fa-calendar-alt"></i><span id="currentDate"></span></div>
                    <div class="header-user">
                        <div class="user-avatar">M</div>
                        <div><span class="user-name"><c:out value="${sessionScope.authUser.fullName}"/></span><br><span class="user-role">Manager</span></div>
                    </div>
                </div>
            </header>
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            ...
                            <p>Quản lý danh sách và số lượng nguyên liệu cần thiết cho bếp</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị danh sách nguyên liệu với chức năng CRUD (Thêm, Sửa, Xóa).</p>
                    <span class="team-badge">Thành viên 2 sẽ triển khai</span>
                </div>
            </main>
        </div>
    </div>
