    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/manager/students" class="active"><span class="nav-icon"><i class="fas fa-user-graduate"></i></span><span>Học sinh</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Học sinh</h2>
                    <span>Quản lý thông tin học sinh</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            ...
                            <p>Thêm, sửa, xóa thông tin học sinh trong trường</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị danh sách học sinh với chức năng CRUD (Thêm, Sửa, Xóa).</p>
