...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== FORM ===== */
        .form-card { background: rgba(255, 255, 255, 0.98); border: 1px solid rgba(249, 115, 22, 0.1); border-radius: 14px; padding: 32px; box-shadow: 0 4px 15px rgba(249, 115, 22, 0.05); max-width: 500px; }
        .form-group { margin-bottom: 20px; }
        .form-group label { display: block; font-weight: 600; color: #7c2d12; margin-bottom: 8px; font-size: 14px; }
    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen"><span class="nav-icon"><i class="fas fa-home"></i></span><span>Tổng quan</span></a></div>
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/change-password" class="active"><span class="nav-icon"><i class="fas fa-key"></i></span><span>Đổi mật khẩu</span></a></div>
            </nav>
            ...
            <main class="page-content">
                ...
                <div class="form-card">
                    <c:if test="${not empty error}">
                        <div style="background: #fee2e2; color: #dc2626; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-weight: 500;">
                            <i class="fas fa-exclamation-circle"></i> ${error}
                        </div>
                    </c:if>
                    <c:if test="${not empty success}">
                        <div style="background: #dcfce7; color: #16a34a; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-weight: 500;">
