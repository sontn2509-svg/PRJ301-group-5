...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== COMING SOON ===== */
        .coming-soon { background: rgba(255, 255, 255, 0.98); border: 1px solid rgba(249, 115, 22, 0.1); border-radius: 14px; padding: 60px; text-align: center; box-shadow: 0 4px 15px rgba(249, 115, 22, 0.05); }
    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/meal-count" class="active"><span class="nav-icon"><i class="fas fa-utensils"></i></span><span>Số suất ăn</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Số suất ăn</h2>
                    <span>Xem số lượng suất ăn theo ngày</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Số suất ăn</h1>
                            <p>Xem danh sách học sinh có mặt và số suất ăn cần chuẩn bị</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị danh sách học sinh có mặt và số suất ăn cần chuẩn bị theo từng ngày.</p>
