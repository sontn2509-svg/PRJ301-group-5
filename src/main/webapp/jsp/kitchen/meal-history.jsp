    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/meal-history" class="active"><span class="nav-icon"><i class="fas fa-history"></i></span><span>Lịch sử bếp</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Lịch sử bếp</h2>
                    <span>Xem lại các bữa ăn đã nấu</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Lịch sử bếp</h1>
                            <p>Xem lại lịch sử các bữa ăn đã nấu trong tháng</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị lịch sử các bữa ăn đã nấu, bao gồm ngày, thực đơn và số suất ăn đã chuẩn bị.</p>
