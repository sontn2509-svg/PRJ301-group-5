...
<head>
    ...
    <title>Bếp - KindergartenKitchen</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== COMING SOON ===== */
        .coming-soon-card { background: rgba(255, 255, 255, 0.98); border: 1px solid rgba(249, 115, 22, 0.1); border-radius: 14px; padding: 24px; box-shadow: 0 4px 15px rgba(249, 115, 22, 0.05); }
        .coming-soon-card h3 { font-size: 16px; font-weight: 700; color: #9a3412; margin-bottom: 12px; display: flex; align-items: center; gap: 10px; }
        .coming-soon-card h3 i { color: #ea580c; }
        .coming-soon-card p { color: #78716c; font-size: 13px; }
        .badge { background: rgba(249, 115, 22, 0.1); color: #ea580c; padding: 4px 10px; border-radius: 12px; font-size: 11px; font-weight: 600; margin-left: auto; }
        
        /* ===== ANIMATION ===== */
        @keyframes fadeInUp { from { opacity: 0; transform: translateY(16px); } to { opacity: 1; transform: translateY(0); } }
        .page-header-card, .stat-card, .info-box, .coming-soon-card { animation: fadeInUp 0.4s ease forwards; }
    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen" class="active"><span class="nav-icon"><i class="fas fa-home"></i></span><span>Tổng quan</span></a></div>
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/meal-count"><span class="nav-icon"><i class="fas fa-utensils"></i></span><span>Số suất ăn</span></a></div>
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/meal-history"><span class="nav-icon"><i class="fas fa-history"></i></span><span>Lịch sử bếp</span></a></div>
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/ingredients"><span class="nav-icon"><i class="fas fa-carrot"></i></span><span>Nguyên liệu</span></a></div>
                <div class="nav-section-label">Tài khoản</div>
                <div class="nav-item"><a href="${pageContext.request.contextPath}/kitchen/change-password"><span class="nav-icon"><i class="fas fa-key"></i></span><span>Đổi mật khẩu</span></a></div>
            </nav>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Tổng quan</h2>
                    <span>Xin chào nhân viên bếp!</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Tổng quan Bếp</h1>
                            <p>Theo dõi số suất ăn và hoạt động của bếp</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <h3>10:30</h3>
                            <p>Giờ chuẩn bị xong</p>
                        </div>
                    </div>
                </div>

                <div class="info-box" style="margin-top: 20px;">
                    <h3><i class="fas fa-info-circle"></i> Hướng dẫn cho Nhân viên bếp</h3>
                    <ul class="info-list">
                        <li><i class="fas fa-utensils"></i> <span>Số suất ăn: Xem danh sách học sinh có mặt và số suất ăn cần chuẩn bị theo ngày</span></li>
                        <li><i class="fas fa-history"></i> <span>Lịch sử bếp: Xem lại lịch sử các bữa ăn đã nấu trong tháng</span></li>
