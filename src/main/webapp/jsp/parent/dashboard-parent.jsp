...
<head>
    ...
    <title>Phụ huynh - KindergartenKitchen</title>
    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/parent" class="active"><span class="nav-icon"><i class="fas fa-home"></i></span><span>Tổng quan</span></a></div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Tổng quan Phụ huynh</h1>
                            <p>Theo dõi tình hình ăn uống của con em mình</p>
                        </div>
                    </div>
                </div>
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-info"><h3>2</h3><p>Con đang theo học</p></div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon green"><i class="fas fa-calendar-check"></i></div>
                        <div class="stat-info"><h3>22</h3><p>Ngày đi học</p></div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-icon orange"><i class="fas fa-user-slash"></i></div>
                        <div class="stat-info"><h3>1</h3><p>Ngày nghỉ ăn</p></div>
                    </div>
                </div>
                <div class="info-box" style="margin-top: 20px;">
                    <h3><i class="fas fa-info-circle"></i> Hướng dẫn cho Phụ huynh</h3>
                    <ul class="info-list">
                        <li><i class="fas fa-child"></i> <span>Con em: Xem thông tin và tình trạng ăn uống của con</span></li>
                        <li><i class="fas fa-user-slash"></i> <span>Xin nghỉ ăn: Gửi yêu cầu xin nghỉ ăn cho con</span></li>
                        <li><i class="fas fa-history"></i> <span>Lịch sử ăn: Xem lịch sử ăn uống của con</span></li>
