                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px">
                            ...
                            <a href="${pageContext.request.contextPath}/parent/absences" class="btn btn-primary" style="justify-content:flex-start"><i class="fas fa-user-slash"></i> Báo nghỉ học cho con</a>
                                    ...
                                    <div class="child-card">
                                        ...
                                        <div class="child-info"><h4>${c.fullName}</h4><p><i class="fas fa-chalkboard" style="margin-right:4px"></i>${c.className}</p></div>
                                            ...
                                            <c:when test="${c.todayStatus == 'absent_meal'}">
                                                <span class="child-status skip"><i class="fas fa-utensils-slash"></i> Báo nghỉ</span>
                                            </c:when>
