    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/parent/my-children" class="active"><span class="nav-icon"><i class="fas fa-child"></i></span><span>Con em</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Con em</h2>
                    <span>Thông tin con em đang theo học</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Thông tin con em</h1>
                            <p>Xem thông tin và tình trạng ăn uống của con em mình</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị thông tin các con đang theo học tại trường.</p>
