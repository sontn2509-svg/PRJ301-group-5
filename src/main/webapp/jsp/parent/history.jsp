    ...
    <div class="app-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-item"><a href="${pageContext.request.contextPath}/parent/history" class="active"><span class="nav-icon"><i class="fas fa-history"></i></span><span>Lịch sử ăn</span></a></div>
        ...
        <div class="main-content">
            <header class="header">
                <div class="header-greeting">
                    <h2>Lịch sử ăn</h2>
                    <span>Xem lịch sử ăn uống của con</span>
                </div>
            ...
            <main class="page-content">
                <div class="page-header-card">
                    <div class="page-header-content">
                        ...
                        <div>
                            <h1>Lịch sử ăn uống</h1>
                            <p>Xem lại lịch sử ăn uống của con em mình</p>
                        </div>
                    </div>
                </div>
                <div class="coming-soon">
                    ...
                    <p>Trang này sẽ hiển thị lịch sử ăn uống của con theo ngày.</p>
